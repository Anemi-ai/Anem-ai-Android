...
class RegisterPasswordEditText @JvmOverloads constructor(
    ...
    init {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                error = validatePassword(s.toString())
    ...
    private fun validatePassword(password: String): String? {
        ...
        return when {
            password.isEmpty() -> context.getString(R.string.password_must_be_filled)
            !lowercasePattern.containsMatchIn(password) -> context.getString(R.string.password_must_contain_lowercase)
            !uppercasePattern.containsMatchIn(password) -> context.getString(R.string.password_must_contain_uppercase)
            !specialCharacterPattern.containsMatchIn(password) -> context.getString(R.string.password_must_contain_special_character)
            else -> null
        }
    }
}